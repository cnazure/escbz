<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="New_SellOrder.aspx.cs" Inherits="UsedCarSolution.Order.New_SellOrder" %>
...
<body>
    <form id="form2" runat="server">
        ...
        <div class="right_bg_title">
            <div class="weizi">
                <strong class="bg">当前位置：</strong> <span class="ce1">订单管理</span>—<span class="ce2">销售办证订单</span>
            </div>
            <div class="fanhui">
