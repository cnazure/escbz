<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DistributionOrder.aspx.cs" Inherits="UsedCarSolution.Order.DistributionOrder" %>
                ...
                <div class="searchcont">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_search">                       
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="DropSales" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
                    </table>
                </div>
                <span>
                    <asp:Button ID="btnFendan" runat="server" Text="提 交" CssClass="btn_ok_big" OnClick="btnSave_Click" />
                    <input id="btnBack" class="btn_white_big" type="button" value="返 回" onclick="javascript: history.go(-1)">                                  
